defmodule EarWitness.Audio.SpeakerDiarizationSplitter do
  use Membrane.Filter

  alias Membrane.{RawAudio, Buffer}
  alias EarWitness.Audio.Windows
  ...
  def handle_stream_format(:input, stream_format, _ctx, state) do
    ...
    model =
      Ortex.load(Path.join([:code.priv_dir(:ear_witness), "models", "segmentation-3.0.onnx"]))
