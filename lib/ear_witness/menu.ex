defmodule EarWitness.Menu do
  @moduledoc """
    Menu that is shown when a user click on the taskbar icon of the EarWitness
  """
  ...
  def handle_event(command, menu) do
    case command do
      <<"toggle:", id::binary>> -> EarWitness.Todo.toggle_todo(String.to_integer(id))
  ...
  def mount(menu) do
    EarWitness.Todo.subscribe()
    menu = assign(menu, todos: EarWitness.Todo.all_todos())
    set_state_icon(menu)
    {:ok, menu}
  end
